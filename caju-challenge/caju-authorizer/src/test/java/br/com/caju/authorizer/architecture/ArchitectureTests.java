package br.com.caju.authorizer.architecture;
...
@AnalyzeClasses(packages = "br.com.caju.authorizer")
public class ArchitectureTests {
    ...
    @ArchTest
    public final ArchRule controllerCannotCallRepositoryDirectly = ArchRuleDefinition.noClasses()
            .that().resideInAPackage("..controller..")
            .should().dependOnClassesThat().resideInAPackage("..repository..")
            .as("Controller cannot call repository directly");
    ...
    @ArchTest
    public final ArchRule dependencyInjectionTest = GeneralCodingRules.NO_CLASSES_SHOULD_USE_FIELD_INJECTION;
}
